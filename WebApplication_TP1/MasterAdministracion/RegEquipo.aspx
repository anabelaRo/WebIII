...
<%--		</div>--%>
		...
		<%--<asp:Button ID="btnCrear" runat="server" Text="Crear" onclick="btnCrear_Click" OnClientClick="return valCamposRegEquipo();"/>--%>
        <asp:Button ID="btnCrear" runat="server" Text="Crear" OnClientClick="return valCamposRegEquipo();"/>
