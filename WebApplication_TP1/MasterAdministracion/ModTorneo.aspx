			...
			<div class="row">
				...
				<div class="col-md-2">
					...
					<asp:DropDownList ID="ddlTorneos" runat="server" class="form-control">
                    	...
                    	<asp:Button ID="Button2" runat="server" Text="Siguiente" onclick="btnSig_Click"  class="btn btn-default"/>
				</div>
			</div>
            </div>
            </div>
            ...
            <div runat="server" id="modificar2">
			    ...
			    <div class="row">
				    <div class="col-md-4 col-md-offset-4"><br />
                        ...
                        <br />	<br /><asp:Label ID="lblTorModificado" runat="server" Text=""></asp:Label>
				    </div>
			    </div>
            </div>
		</div>
